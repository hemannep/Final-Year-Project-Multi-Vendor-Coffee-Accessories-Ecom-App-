        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text('Approve (Public)'),
              subtitle: const Text('Visible to all users'),
              onTap: () {
                Navigator.pop(context);
                onStatusChanged(product.product_id ?? '', 'public');
              },
            ),
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                onStatusChanged(product.product_id ?? '', 'private');
              },
            ),
            ListTile(
              leading: const Icon(Icons.block, color: Colors.red),
              title: const Text('Reject'),
              subtitle: const Text('Product will be hidden'),
              onTap: () {
                Navigator.pop(context);
                onStatusChanged(product.product_id ?? '', 'rejected');
              },
            ),
            const SizedBox(height: 16),
            TextButton(
